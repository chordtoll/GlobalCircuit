...
//#define BALLAST RBRXbuf[0]==0xF0&&RBRXbuf[1]==0x9F&&RBRXbuf[2]==0x92&&RBRXbuf[3]==0xB0
//#define CUTDOWN RBRXbuf[0]==0xE2&&RBRXbuf[1]==0x9C&&RBRXbuf[2]==0x82&&RBRXbuf[3]==0x20
//#define REQUEST RBRXbuf[4]==0xF0&&RBRXbuf[5]==0x9F&&RBRXbuf[6]==0x99&&RBRXbuf[7]==0x83
//#define CONFIRM RBRXbuf[4]==0xF0&&RBRXbuf[5]==0x9F&&RBRXbuf[6]==0x91&&RBRXbuf[7]==0x8D
...
typedef enum rb_state  {RB_INIT,SENT_ATEo,SENT_ATnKo,SENT_SBDMTA,SENT_SBDDo,RB_IDLE,BEGINSEND,SENT_SBDWB,SENDING_TXBUF,SENT_TXBUF,SENT_CSUM,SENT_SBDIX,SENT_SBDRB,SENT_ACKAT, SENT_ATnDo, CHECK_SIG, SENT_CSQ, SENT_CGSN, S1, S2, S3,S4,S5,S6} rb_state_t;
